#Calculate Kinship and Principal Components for 4K and 55K and GBS SNPs using traditional MLM
#######################################################################################
#Step 1: Import files
#######################################################################################
setwd() 
...
myY  <- read.table("mdp_traits.csv", head = TRUE) #read in phenotype (theorectically this step is not necessary 
